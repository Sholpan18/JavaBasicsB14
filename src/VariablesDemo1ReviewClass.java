...
public class VariablesDemo1ReviewClass {
	...
	public static void main(String[] args) {
		 ...
		 * waste a lot of space from RAM (Memory where computer stores the programs wich are 
		 * opened and running currently).
		 */
		int box1=12;
		//char box1='S'; is not allowed as it creates confusion 
		//int =>data type
		//box1=>variable name
		// = is called assignment operator and used to store data in variable
		//12 it is the data that we want to store in box1
